...
od_classes = [classes[1]]                                                                   ######begning = 0 insitu = 1
id_classes.sort()
od_classes.sort()
...
def tsne_visualize(model,loader, perplexity,learning_rate, n_iter, random_state):
  ...
  plt.legend(loc = 'best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/BACH/softmax_TSNE.png')
...
for ep in range(1,epoch+1):
  ...
  if min_val_loss > loss:
    min_val_loss = loss
    early_stop_counter = 0
    torch.save(full_model.state_dict(), "/home/abhiraj/DDP/CL/models/HistoSimCLR/softmax_bach.pt")
  else:
...
full_model.load_state_dict(torch.load("/home/abhiraj/DDP/CL/models/HistoSimCLR/softmax_bach.pt"))
...
def detect_ood(model, loader,n_clusters, test_type):
  ...
  df_scores.to_csv('/home/abhiraj/DDP/CL/eval/BACH/softmax_test_scores.csv', index=False)
  ...
  plt.legend(loc = 'best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/BACH/softmax_OOD_cdf.png')
  ...
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/BACH/softmax_OOD_score.png')

  plt.figure()
  plt.plot(FPR_arr, TPR_arr, '-', label='auc')
  plt.title('ROC curve, AUC= '+ str(auc_score))
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/BACH/softmax_AUROC.png')
  ...
  for dat in ood_list:
    ...
    plt.title(str(dat[0])) 
    plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/BACH/'+test_type+'_od_softmax_'+str(count)+'.png') #####################
    if count == 5:
      break
  ...
  for dat in correct_list:
    ...
    plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/BACH/'+test_type+'_softmax_'+str(count)+'.png')
    if count == 5:
      break
  ...
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/eval/BACH/softmax_accuracy.png')
############################################################################################
...
def detect_ood_odin(model, loader, temparature, epsilon,n_clusters, test_type):
  ...
  df_scores.to_csv('/home/abhiraj/DDP/CL/eval/BACH/odin_test_scores.csv', index=False)
  ...
  plt.title('Cummulative density of ID and OD')
  plt.legend(loc = 'best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/BACH/odin_OOD_cdf.png')
  ...
  plt.title('CLS ACC : '+ str(sum(class_wise_correct)/sum(class_wise_total)) + ' FPR95: '+str(fpr95)+'\n O25: '+str(round(odac25,4))+' O50: '+str(round(odac50,4))+' O75: '+str(round(odac75,4))+' O90: '+str(round(odac90,4))+'\n I25: '+str(round(idac25,4))+' I50: '+str(round(idac50,4))+' I75: '+str(round(idac75,4))+' I90: '+str(round(idac90,4)))
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/BACH/odin_OOD_score.png')
  ...
  plt.savefig('/home/abhiraj/DDP/CL/plots/BACH/odin_AUROC.png')
  ...
  for dat in ood_list:
    ...
    plt.imshow(np.asarray(dat[2]))
    plt.title(str(dat[0])) 
    plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/BACH/'+test_type+'_od_odin_'+str(count)+'.png') #####################
    if count == 5:
      break
  ...
  for dat in correct_list:
    ...
    plt.imshow(np.asarray(dat[3]))
    plt.title(str(dat[4])+ ' : '+ str(dat[0]))
    plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/BACH/'+test_type+'_odin_'+str(count)+'.png')
    if count == 5:
      break
  ...
  plt.title('Accuracy vs %data left')
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/eval/BACH/odin_accuracy.png')
    ...
    for j in range(len(label)):
      ...
      if d_type[j] == 'id':
        if label[j] == prediction[j]:
          save_file_path_he = '/home/abhiraj/DDP/CL/eval/BACH/GRADCAM/SOFTMAX/softmax_id_correct_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
          save_file_path_heat = '/home/abhiraj/DDP/CL/eval/BACH/GRADCAM/SOFTMAX/softmax_id_correct_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
        else:
          save_file_path_he = '/home/abhiraj/DDP/CL/eval/BACH/GRADCAM/SOFTMAX/softmax_id_incorrect_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
          save_file_path_heat = '/home/abhiraj/DDP/CL/eval/BACH/GRADCAM/SOFTMAX/softmax_id_incorrect_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
      if d_type[j] == 'od':
        save_file_path_he = '/home/abhiraj/DDP/CL/eval/BACH/GRADCAM/SOFTMAX/softmax_od_gradcam_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
        save_file_path_heat = '/home/abhiraj/DDP/CL/eval/BACH/GRADCAM/SOFTMAX/softmax_od_gradcam_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
