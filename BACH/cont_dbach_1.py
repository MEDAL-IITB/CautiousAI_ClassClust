...
def tsne_visualize(model,loader, feats,perplexity,learning_rate, n_iter, random_state, file_name):
  ...
  plt.legend(loc = 'best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/DBACH/'+file_name)  ##here
...
#     torch.save(full_model.state_dict(), "/home/abhiraj/DDP/CL/models/HistoSimCLR/cont_dbach.pt")
#     early_stop_counter = 0
#   else:
...
full_model.load_state_dict(torch.load("/home/abhiraj/DDP/CL/models/HistoSimCLR/cont_dbach.pt"))
# prev_val_acc = 101
...
def kmeans_predictor(model, train_loader, test_loader, n_clusters, test_type, thresh_ip = None):
    ...
    for i, sample in enumerate(test_loader, 0):
      ...
      for it in range(z_i.shape[0]):
        if d_type[it] == 'id':
          ...
          od_total+=1
  df_scores.to_csv('/home/abhiraj/DDP/CL/eval/DBACH/ckmeans_test_scores.csv', index=False)
  ...
  plt.legend(loc = 'best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/DBACH/cont_kmeans_OOD_cdf.png')
  ...
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/DBACH/cont_kmeans_OOD_score.png') ##here
  
  plt.figure()
  plt.plot(FPR_arr, TPR_arr, '-', label='auc')
  plt.title('ROC curve, AUC = '+str(auc_score))
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/DBACH/cont_kmeans_AUROC.png') ##here
  ...
  for dat in ood_list:
    ...
    plt.title(str(dat[0])) 
    plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/DBACH/'+test_type+'_od_cont_kmeans_'+str(count)+'.png') #####################
    if count == 5:
      break
  ...
  for dat in correct_list:
    ...
    plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/DBACH/'+test_type+'_cont_kmeans_'+str(count)+'.png')
    if count == 5:
      break
  ...
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/eval/DBACH/'+test_type+'_cont_kmeans_accuracy.png')
...
def lof_predictor(model, train_loader, test_loader, n_clusters, test_type, thresh_ip = None):
    ...
    for i, sample in enumerate(test_loader, 0):
      ...
      for it in range(z_i.shape[0]):
        if d_type[it] == 'id':
          ...
          od_total+=1
  df_scores.to_csv('/home/abhiraj/DDP/CL/eval/DBACH/clof_test_scores.csv', index=False)
  max_score = max([max(id_hist),max(od_hist)])
  min_score = min([min(id_hist),min(od_hist)])
  max_sum = 0
  thresh = 0
  ...
  plt.title('Cummulative density of ID and OD')
  plt.legend(loc = 'best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/DBACH/cont_lof_OOD_cdf.png')
  ...
  plt.title('CLS ACC : '+ str(sum(class_wise_correct)/sum(class_wise_total)) + ' FPR95: '+str(fpr95)+'\n O25: '+str(round(odac25,4))+' O50: '+str(round(odac50,4))+' O75: '+str(round(odac75,4))+' O90: '+str(round(odac90,4))+'\n I25: '+str(round(idac25,4))+' I50: '+str(round(idac50,4))+' I75: '+str(round(idac75,4))+' I90: '+str(round(idac90,4)))
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/DBACH/cont_lof_OOD_score.png') ##here

  plt.figure()
  plt.plot(FPR_arr, TPR_arr, '-', label='auc')
  plt.title('AUC : '+ str(auc_score))
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/plots/DBACH/cont_lof_AUROC.png') ##here
  ...
  for dat in ood_list:
    ...
    plt.imshow(np.asarray(dat[2]))
    plt.title(str(dat[0])) 
    plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/DBACH/'+test_type+'_od_cont_lof_'+str(count)+'.png') #####################
    if count == 5:
      break
  ...
  for dat in correct_list:
    ...
    plt.imshow(np.asarray(dat[3]))
    plt.title(str(dat[4])+ ' : '+ str(dat[0]))
    plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/DBACH/'+test_type+'_cont_lof_'+str(count)+'.png')
    if count == 5:
      break
  ...
  plt.title('Accuracy vs %data left')
  plt.legend(loc='best')
  plt.savefig('/home/abhiraj/DDP/CL/eval/DBACH/'+test_type+'_cont_lof_accuracy.png')
    ...
    for i, sample in enumerate(loader, 0):
      ...
      for j in range(len(score)):
        if d_type[j] == 'fd':
          ...
          df_scores = df_scores.append({'type':d_type[j],'label':int(lb[j]),'pred': int(score[j][1]),'score':score[j][0],'path':im_paths[j]}, ignore_index = True )
          class_wise_total[lb[j]] += 1
          id_total+=1
  df_scores.to_csv('/home/abhiraj/DDP/CL/eval/DBACH/cgfit_test_scores1.csv', index=False)
...
#   plt.title('Cummulative density of ID and OD')
#   plt.legend(loc = 'best')
#   plt.savefig('/home/abhiraj/DDP/CL/plots/DBACH/cont_gfit_OOD_cdf.png')
...
#   plt.title('CLS ACC : '+ str(sum(class_wise_correct)/sum(class_wise_total)) + ' FPR95: '+str(fpr95)+'\n O25: '+str(round(odac25,4))+' O50: '+str(round(odac50,4))+' O75: '+str(round(odac75,4))+' O90: '+str(round(odac90,4))+'\n I25: '+str(round(idac25,4))+' I50: '+str(round(idac50,4))+' I75: '+str(round(idac75,4))+' I90: '+str(round(idac90,4)))
#   plt.legend(loc='best')
#   plt.savefig('/home/abhiraj/DDP/CL/plots/DBACH/cont_gfit_OOD_score.png') ##here
  
#   plt.figure()
#   plt.plot(FPR_arr, TPR_arr, '-', label='auc')
#   plt.title('ROC curve, AUC ='+ str(auc_score))
#   plt.legend(loc='best')
#   plt.savefig('/home/abhiraj/DDP/CL/plots/DBACH/cont_gfit_AUROC.png') ##here
...
#     plt.imshow(np.asarray(dat[2]))
#     plt.title(str(dat[0])) 
#     plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/DBACH/'+test_type+'_od_cont_gift_'+str(count)+'.png') #####################
#     if count == 5:
#       break
...
#     plt.imshow(np.asarray(dat[2]))
#     plt.title(str(dat[0]))
#     plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/DBACH/'+test_type+'_od_cont_gfit_'+str(count)+'.png') ######################
#     if count == 10:
#       break
...
#    plt.imshow(np.asarray(dat[3]))
#    plt.title(str(dat[4])+ ' : '+ str(dat[0]))
#    plt.savefig('/home/abhiraj/DDP/CL/code/Contrastive/sample_images/DBACH/'+test_type+'_cont_gfit_'+str(count)+'.png')
#    if count == 5:
#      break
...
#   plt.title('Accuracy vs %data left')
#   plt.legend(loc='best')
#   plt.savefig('/home/abhiraj/DDP/CL/eval/DBACH/'+test_type+'_cont_gfit_accuracy.png')
####################################################################################################################
    ...
    for j in range(len(label)):
      ...
      if d_type[j] == 'id':
        if lb[j] == kmeans_map[kmeans_obj.predict(np.expand_dims(z_i[j], axis=0))[0]]:
          save_file_path_he = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/kmeans_id_correct_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
          save_file_path_heat = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/kmeans_id_correct_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
        else:
          save_file_path_he = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/kmeans_id_incorrect_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
          save_file_path_heat = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/kmeans_id_incorrect_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
      if d_type[j] == 'od':
        save_file_path_he = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/kmeans_od_gradcam_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
        save_file_path_heat = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/kmeans_od_gradcam_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
...
def generate_gradcam_vis_lof(model, loader, mean, std):
  ...
  for i, sample in enumerate(loader, 0):
    ...
    for j in range(len(label)):
      ...
      if d_type[j] == 'id':
        if label[j] == p_idx:
          save_file_path_he = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/lof_id_correct_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
          save_file_path_heat = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/lof_id_correct_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
        else:
          save_file_path_he = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/lof_id_incorrect_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
          save_file_path_heat = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/lof_id_incorrect_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
      if d_type[j] == 'od':
        save_file_path_he = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/lof_od_gradcam_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
        save_file_path_heat = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/lof_od_gradcam_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
...
def generate_gradcam_vis_gfit(model, loader, mean, std):
  ...
  for i, sample in enumerate(loader, 0):
    ...
    for j in range(len(label)):
      ...
      if d_type[j] == 'id':
        if lb[j] == score[j][1]:
          save_file_path_he = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/gfit_id_correct_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
          save_file_path_heat = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/gfit_id_correct_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
        else:
          save_file_path_he = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/gfit_id_incorrect_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
          save_file_path_heat = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/gfit_id_incorrect_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
      if d_type[j] == 'od':
        save_file_path_he = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/gfit_od_gradcam_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HE.png'
        save_file_path_heat = '/home/abhiraj/DDP/CL/eval/DBACH/GRADCAM/CONT/gfit_od_gradcam_'+bach_class+'_'+id_classes[target_category]+'_'+im_paths[j].split('/')[-1][:-4]+'_'+str(j)+'_HEAT.png'
